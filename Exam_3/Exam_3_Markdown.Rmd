...
```{r}
juniper_raw <- read_csv("../../Data_Course_Adam/Data/Juniper_Oils.csv")
```
View(juniper_raw)
```{r}
juniper <- juniper_raw %>% 
...
# 4. Pivot the chemical‑composition columns into long (tidy) form. All columns from alpha_pinene through thujopsenal become a pair (compound, abundance)
```{r}
